...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">SMA Bopkri Banguntapan</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-a mb-5" src="assets/img/a.png" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Penerimaan Peserta Didik Baru (SMA BOBAYO) Online</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">SMA BOBAYO</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>PPDB Online by Septian koromat - 2023</small></div>
        </div>
